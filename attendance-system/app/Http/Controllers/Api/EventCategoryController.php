...
class EventCategoryController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            $record = AttendanceEventCategory::create($validator->validated());

            return response()->json(['data' => $record, 'message' => 'Event category created successfully.'], 201);
        } catch (\Exception $e) {
            return response()->json(['message' => 'Failed to create event category.', 'error' => $e->getMessage()], 500);
        }
    }
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        try {
            ...
            return response()->json(['data' => $record, 'message' => 'Event category updated successfully.']);
        } catch (\Exception $e) {
            return response()->json(['message' => 'Failed to update event category.', 'error' => $e->getMessage()], 500);
        }
    }
    ...
    public function destroy($id): JsonResponse
    {
        ...
        try {
            ...
            return response()->json(['message' => 'Failed to delete event category.', 'error' => $e->getMessage()], 500);
        }
    }
