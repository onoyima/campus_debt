...
class DebtPaymentController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            $record = AttendanceDebtPayment::create($validator->validated());

            return response()->json(['data' => $record, 'message' => 'Debt payment recorded successfully.'], 201);
        } catch (\Exception $e) {
            return response()->json(['message' => 'Failed to record debt payment.', 'error' => $e->getMessage()], 500);
        }
    }
    ...
    public function show(Request $request, $id): JsonResponse
    {
        ...
        if (! $record) {
            return response()->json(['message' => 'Debt payment not found.'], 404);
        }
    ...
    public function update(Request $request, $id): JsonResponse
    {
        ...
        try {
            ...
            return response()->json(['data' => $record, 'message' => 'Debt payment updated successfully.']);
        } catch (\Exception $e) {
            return response()->json(['message' => 'Failed to update debt payment.', 'error' => $e->getMessage()], 500);
        }
    }
    ...
    public function destroy($id): JsonResponse
    {
        ...
        try {
            ...
            return response()->json(['message' => 'Failed to delete debt payment.', 'error' => $e->getMessage()], 500);
        }
    }

    public function restore(int $id): JsonResponse
    {
        $model = AttendanceDebtPayment::withTrashed()->findOrFail($id);
        $model->restore();
